...
<link rel="stylesheet" href="../../../css/citas/contrato.css">
</head>

<body>
    
    <h1>Formulario de Citas de Seguimiento de Contrato de Aprendizaje </h1>
...
if ($_POST){
      ...
      try{
          ...
          $stm = $pdo->prepare('CALL InsertarCitasContrato(?,?,?,?,?,?,?)');
